...
class DeepseekV2ForCausalLM(DeepseekV2PreTrainedModel):
    ...
    def prepare_inputs_for_generation(
        ...
        # modifications are referenced from https://github.com/deepseek-ai/DeepSeek-VL2/issues/4#issuecomment-2562709343
        if inputs_embeds is not None and (past_key_values is None or cache_length == 0 ): # modified by Xixi
